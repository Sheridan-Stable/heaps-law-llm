...
#	json_files = glob.glob('*.json')
	...
	output_file = f"finalize_human_3.csv"

	# Define fixed seeds for reproducibility
	fixed_seeds = [
            345, 678, 987, 234, 567, 890, 135,
            246, 357, 468, 579, 680, 791, 802, 913, 1024, 1135,
            1246, 1357, 1468, 1579, 1680, 1791, 1902, 2013, 2124,
            2235, 2346, 2457, 2568, 2679, 2780, 2891, 3002, 3113,4987
        ]
	...
	with open(output_file, 'a', newline='') as f:
	    ...
	    for file_path in json_files:
	        ...
	        for i in range(36):  # Three different shuffled versions per file
	            ...
	            print(f"Processing {file_name} - Iteration {i+1} - Using Seed {seed}")
